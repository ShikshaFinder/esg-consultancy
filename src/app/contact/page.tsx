...
const contactMethods = [
  { icon: Phone, title: "Phone", value: "+91 99980 35607", sub: "Mon — Sat, 9 AM — 7 PM IST", href: "tel:+919998035607", color: "#355872" },
  { icon: Mail, title: "Email", value: "growbridgeinfo@gmail.com", sub: "Response within 2 hours", href: "mailto:growbridgeinfo@gmail.com", color: "#7AAACE" },
  { icon: MessageCircle, title: "WhatsApp", value: "+91 99980 35607", sub: "Quick chat support", href: "https://wa.me/919998035607", color: "#22c55e" },
  { icon: MapPin, title: "Office", value: "630, Solaris Business Hub, Sola Rd, Ahmedabad 380063", sub: "Serving clients Pan India", href: "https://maps.google.com/?q=Solaris+Business+Hub+Sola+Road+Ahmedabad", color: "#9CD5FF" },
]
      ...
      <main>
        ...
        <section className="relative pt-32 pb-20 px-6 bg-[#060e1a] overflow-hidden">
          ...
          <motion.div className="max-w-4xl mx-auto text-center relative z-10" initial="hidden" animate="show" variants={stagger}>
            <motion.span variants={fadeUp} className="text-[11px] font-bold tracking-[0.18em] uppercase text-black block mb-4">Contact Us</motion.span>
            <motion.h1 variants={fadeUp} className="text-4xl md:text-6xl font-bold text-black leading-tight mb-6">
              Let&apos;s Build Your{" "}
              <span style={{ background: "linear-gradient(90deg,#9CD5FF,#355872)", WebkitBackgroundClip: "text", WebkitTextFillColor: "#000000", backgroundClip: "text" }}>Success Story</span>
            </motion.h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {contactMethods.map((c, i) => (
                ...
                >
                  ...
                  <p className="text-black font-bold text-sm mb-0.5">{c.title}</p>
                  <p className="text-black text-sm font-medium group-hover:text-black transition-colors">{c.value}</p>
                  <p className="text-black/35 text-[11px] mt-1">{c.sub}</p>
                </motion.a>
              ))}
            </div>
          </motion.div>
          ...
          <motion.div className="max-w-5xl mx-auto" initial="hidden" whileInView="show" viewport={{ once: true }} variants={stagger}>
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
              ...
              <motion.div variants={fadeUp} className="lg:col-span-3">
                <h2 className="text-2xl md:text-3xl font-bold text-black mb-2">Send Us a Message</h2>
                <p className="text-black/50 text-sm mb-8">Fill in the form below and our team will get back to you within 30 minutes during business hours.</p>

                <form className="space-y-5" onSubmit={(e) => { e.preventDefault(); window.open("https://wa.me/919998035607", "_blank") }}>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input type="text" required placeholder="Rahul Sharma"
                        className="w-full h-11 px-4 rounded-xl border border-[#355872]/10 bg-[#F7F8F0] text-black text-sm placeholder:text-black/25 focus:border-[#355872]/30 focus:ring-2 focus:ring-[#355872]/10 outline-none transition-all" />
                    </div>
                    <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      <label className="text-black/70 text-xs font-medium mb-1.5 block">Business Name</label>
                      <input type="text" placeholder="Your Business Pvt Ltd"
                        className="w-full h-11 px-4 rounded-xl border border-[#355872]/10 bg-[#F7F8F0] text-black text-sm placeholder:text-black/25 focus:border-[#355872]/30 focus:ring-2 focus:ring-[#355872]/10 outline-none transition-all" />
                    </div>
                  </div>
                  <div>
                    <label className="text-black/70 text-xs font-medium mb-1.5 block">Service Interested In</label>
                    <select className="w-full h-11 px-4 rounded-xl border border-[#355872]/10 bg-[#F7F8F0] text-black text-sm focus:border-[#355872]/30 focus:ring-2 focus:ring-[#355872]/10 outline-none transition-all appearance-none">
                  ...
                  <div>
                    <label className="text-black/70 text-xs font-medium mb-1.5 block">Your Message</label>
                    <textarea rows={4} placeholder="Tell us about your business, current stage, and how we can help..."
                      className="w-full px-4 py-3 rounded-xl border border-[#355872]/10 bg-[#F7F8F0] text-black text-sm placeholder:text-black/25 focus:border-[#355872]/30 focus:ring-2 focus:ring-[#355872]/10 outline-none transition-all resize-none" />
                  </div>
              ...
              <motion.div variants={fadeUp} className="lg:col-span-2 flex flex-col gap-5">
                <div className="rounded-2xl border border-[#355872]/10 bg-[#F7F8F0] p-6">
                  ...
                  <h3 className="text-black font-bold text-lg mb-1">Free Consultation Call</h3>
                  <p className="text-black/50 text-sm mb-4">Schedule a 30-minute call with our funding experts to discuss eligibility, documentation, and timelines.</p>
                ...
                <div className="rounded-2xl border border-[#355872]/10 bg-[#F7F8F0] p-6">
                  ...
                  <h3 className="text-black font-bold text-lg mb-3">Business Hours</h3>
                  <div className="space-y-2 text-sm">
                    {[
                      ...
                      <div key={h.day} className="flex justify-between">
                        ...
                        <span className="text-black font-medium">{h.time}</span>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div className="rounded-2xl border border-[#355872]/10 bg-gradient-to-br from-[#355872]/5 to-[#7AAACE]/5 p-6 flex-1">
                  ...
                  <h3 className="text-black font-bold text-lg mb-1">Serving Pan India</h3>
                  <p className="text-black/50 text-sm mb-3">630, Grow Bridge Consultancy, Solaris Business Hub, Sola Rd, Ahmedabad, Gujarat 380063. Serving clients Pan India — 100% digital process.</p>
                  <div className="flex flex-wrap gap-2">
                    {["Gujarat", "Maharashtra", "Rajasthan", "Karnataka", "Delhi", "UP", "18+ States"].map(s => (
                      <span key={s} className="text-[10px] font-medium text-black bg-white border border-[#355872]/10 px-2 py-1 rounded-full">{s}</span>
                    ))}
                  </div>
                </div>
              </motion.div>
        ...
        <section className="h-[350px] bg-[#F7F8F0] relative">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3671.0!2d72.5!3d23.05!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2sSolaris%20Business%20Hub%20Sola%20Road%20Ahmedabad!5e0!3m2!1sen!2sin!4v1700000000000!5m2!1sen!2sin"
