...
export default function PremiumConsultation() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitted(true)
    window.open(
      `https://wa.me/919998035607?text=${encodeURIComponent(msg)}`,
      "_blank"
    )
  }

  return (
    <section className="relative overflow-hidden py-24 px-6" style={{ background: "linear-gradient(180deg, #FFF8F0 0%, #FFF8F0 100%)" }}>
      {/* Background glows */}
      ...
      >
        ...
        <motion.div
          variants={blurFadeUp}
          className="rounded-[2rem] overflow-hidden border border-white/25 shadow-[0_20px_80px_rgba(0,0,0,0.25)] backdrop-blur-sm"
        >
          <div className="flex flex-col lg:flex-row min-h-[520px]">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="inline-flex items-center gap-2 bg-[#526D82]/25 rounded-full px-3.5 py-1.5 border border-white/25 mb-5 backdrop-blur-sm">
                  ...
                  <span className="text-black/90 text-xs font-semibold">
                    Grow Bridge · Active Now
                  </span>
                </div>

                <h3 className="text-2xl font-bold text-black mb-1.5">
                  Talk to an Expert
                </h3>
                  ...
                  {[
                    {
                      icon: MapPin,
                      label: "LOCATION",
                      value: "Sola Rd, Ahmedabad 380063",
                      color: "text-rose-400",
                    ...
                    },
                    {
                      icon: Mail,
                      label: "EMAIL",
                      value: "growbridgeinfo@gmail.com",
                    ...
                    <div key={item.label} className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="text-black/60 text-[10px] uppercase tracking-widest font-bold">
                          {item.label}
                        </p>
                        <p className="text-black text-sm font-semibold mt-0.5 leading-tight">
                          {item.value}
                        </p>
                      </div>
                    </div>
            ...
            <div className="lg:w-[58%] bg-[#DDE6ED] p-8 lg:p-12 flex flex-col justify-center">
              <span className="inline-block text-xs font-bold text-black bg-[#9DB2BF]/25 rounded-full px-3.5 py-1.5 mb-4 w-fit border border-white/25">
                Free Consultation
              </span>
              <h3 className="text-2xl font-bold text-black mb-1.5">
                Check Your Eligibility
              </h3>
              <p className="text-sm text-black mb-7 font-medium">
              ...
              {!submitted ? (
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-11 pr-4 py-3.5 rounded-xl border border-white/25 bg-white text-sm text-black font-medium focus:outline-none focus:border-[#526D82] focus:ring-2 focus:ring-[#526D82]/20 transition-all placeholder:text-black"
                        value={form.name}
                  ...
                  <button
                    type="submit"
                    disabled={submitting}
                    className="group/btn relative w-full py-4 rounded-xl text-black font-bold text-sm tracking-wide transition-all duration-500 hover:shadow-xl hover:shadow-[#1B4F8A]/20 disabled:opacity-70 mt-2 cursor-pointer overflow-hidden"
                    style={{
                      background: "linear-gradient(135deg, #EBF4FF 0%, #2E7DD9 100%)",
                  ...
                  <p className="text-center text-xs text-black/70 font-medium flex items-center justify-center gap-1.5">
              ...
              {/* Trust row */}
              <div className="mt-6 pt-6 border-t border-white/25 flex justify-around text-center">
                {[
                  ["500+", "FUNDED"],
                  ["95%", "SUCCESS"],
                  ["24hr", "RESPONSE"],
