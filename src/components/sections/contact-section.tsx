...
const contactCards = [
  { icon: Phone, title: "Call Us", value: "+91 84878 28752", sub: "Mon — Sat, 9 AM — 7 PM IST", href: "tel:+918487828752", color: "#355872" },
  { icon: Mail, title: "Email Us", value: "abhay@growbridge.org", sub: "We reply within 2 hours", href: "mailto:abhay@growbridge.org", color: "#7AAACE" },
  { icon: MapPin, title: "Visit Us", value: "Ahmedabad, Gujarat", sub: "India — Serving Pan India", href: "https://maps.google.com/?q=Ahmedabad,Gujarat", color: "#9CD5FF" },
]
    ...
    <section id="contact" className="py-24 px-6 bg-[#060e1a] relative overflow-hidden">
      ...
      <motion.div className="max-w-7xl mx-auto relative z-10" initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.08 }} variants={stagger}>
        ...
        <div className="text-center mb-14">
          <motion.span variants={fadeUp} className="text-[11px] font-bold tracking-[0.18em] uppercase text-[#9CD5FF] block mb-3">Get In Touch</motion.span>
          <motion.h2 variants={fadeUp} className="text-3xl md:text-5xl font-bold text-white leading-tight">
            Let&apos;s Start Your{" "}
            <span style={{ background: "linear-gradient(90deg,#9CD5FF,#355872)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>Growth Journey</span>
          </motion.h2>
          <motion.p variants={fadeUp} className="text-white/50 text-base mt-3 max-w-lg mx-auto">
          ...
          {contactCards.map((c, i) => (
            ...
            >
              ...
              <div>
                ...
                <p className="text-white/30 text-[11px] mt-1">{c.sub}</p>
              </div>
            </a>
          ))}
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
          ...
          <motion.div variants={fadeUp} className="lg:col-span-3 rounded-2xl border border-white/[0.08] bg-white/[0.03] p-8">
            <h3 className="text-white font-bold text-xl mb-1">Request a Callback</h3>
            <p className="text-white/40 text-sm mb-6">Fill in your details and our experts will reach out within 30 minutes during business hours.</p>
            <form className="grid grid-cols-1 sm:grid-cols-2 gap-4" onSubmit={(e) => { e.preventDefault(); window.open("https://wa.me/918487828752", "_blank") }}>
              <div>
                ...
                <input type="text" required placeholder="Rahul Sharma"
                  className="w-full h-11 px-4 rounded-xl border border-white/[0.08] bg-white/[0.04] text-white text-sm placeholder:text-white/20 focus:border-[#355872]/40 focus:ring-1 focus:ring-[#355872]/30 outline-none transition-all" />
              </div>
              <div>
              ...
              <div>
                <label className="text-white/60 text-xs font-medium mb-1.5 block">Interested Service</label>
                <select className="w-full h-11 px-4 rounded-xl border border-white/[0.08] bg-white/[0.04] text-white text-sm focus:border-[#355872]/40 focus:ring-1 focus:ring-[#355872]/30 outline-none transition-all appearance-none">
              ...
              <div className="sm:col-span-2">
                <label className="text-white/60 text-xs font-medium mb-1.5 block">Brief Description</label>
          ...
          <motion.div variants={fadeUp} className="lg:col-span-2 flex flex-col gap-5">
            <div className="rounded-2xl border border-white/[0.08] bg-white/[0.03] p-6">
              <div className="flex items-center gap-3 mb-4">
                <Clock className="w-5 h-5 text-[#9CD5FF]" />
            ...
            <div className="rounded-2xl border border-[#355872]/20 bg-gradient-to-br from-[#355872]/10 to-[#7AAACE]/10 p-6 flex-1">
              <Calendar className="w-8 h-8 text-[#9CD5FF] mb-3" />
              <h4 className="text-white font-bold text-lg mb-1">Free Consultation</h4>
              <p className="text-white/50 text-sm mb-5">Schedule a 30-minute free call with our funding experts to discuss your business goals.</p>
              <Link href="/contact"
                className="inline-flex items-center gap-2 text-sm font-semibold text-[#9CD5FF] hover:text-white transition-colors"
              >
            ...
            <div className="rounded-2xl border border-white/[0.08] bg-white/[0.03] p-6">
              <div className="flex items-center gap-2 mb-2">
                {[...Array(5)].map((_, i) => (
                  <div key={i} className="w-7 h-7 rounded-full border-2 border-[#060e1a] bg-gradient-to-br from-[#355872] to-[#7AAACE] -ml-2 first:ml-0 flex items-center justify-center text-[8px] text-white font-bold">
                    {["RK", "PS", "AP", "VK", "SN"][i]}
                  </div>
                ))}
                <span className="text-white/40 text-xs ml-2">+500 happy clients</span>
              </div>
              <p className="text-white/60 text-sm">Trusted by businesses across 18+ states in India</p>
            </div>
          </motion.div>
        </div>
      </motion.div>
